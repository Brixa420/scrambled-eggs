...
logging.basicConfig(
    ...
    handlers=[logging.StreamHandler(), logging.FileHandler("scrambled_eggs_simple.log")],
)
...
class SimpleScrambledEggsGUI(QMainWindow):
    ...
    def __init__(self):
        ...
        status_label = QLabel(
            "The application is running in simple mode with limited functionality."
        )
    ...
    def show_test_message(self):
        ...
        QMessageBox.information(
            self, "Test Message", "This is a test message to verify the GUI is working."
        )
