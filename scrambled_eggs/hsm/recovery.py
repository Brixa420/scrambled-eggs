    ...
    async def restore_backup(
        ...
        **kwargs
        ...
        try:
            ...
            recovery_point = next(
                (rp for rp in self.recovery_points if rp.id == recovery_point_id),
                None
            )
    ...
    async def schedule_backups(self) -> None:
        ...
        try:
            ...
            try:
                ...
                self.logger.error("Invalid backup schedule format. Use 'minute hour day month day_of_week'")
        ...
        try:
            ...
            if state_file.exists():
                with open(state_file, 'r') as f:
                    data = json.load(f)
                    self.recovery_points = [RecoveryPoint.from_dict(p) for p in data.get('recovery_points', [])]
