...
from .key_share import KeyShare, ThresholdKeyShare, KeyShareType
    ...
    def from_bytes(cls, data: bytes) -> 'DKGMessage':
        ...
        try:
            ...
            return cls(
                ...
                recipients=[bytes.fromhex(r) for r in data['recipients']] if 'recipients' in data else None
            )
...
class AsyncDKGClient:
    ...
    async def start(self) -> bool:
        ...
        participant = DKGParticipant(
            ...
            address=None  # We don't know our own address
        )
