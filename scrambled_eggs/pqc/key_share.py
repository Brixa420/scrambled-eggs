...
class ThresholdKeyShare:
    ...
    def __init__(self, key_type: KeyShareType = KeyShareType.SHAMIR):
        ...
        if key_type in (KeyShareType.THRESHOLD_ECDSA, KeyShareType.THRESHOLD_BLS) and not HAS_PYCRYPTODOME:
            raise ImportError(
    ...
    def split_secret(self, 
                    ...
                    threshold: int, 
                    total_shares: int,
                    key_id: Optional[str] = None) -> List[KeyShare]:
        """
    ...
    def _shamir_split(self, secret: bytes, threshold: int, total_shares: int, key_id: str = None) -> List[KeyShare]:
        ...
        for i, share in enumerate(shares):
            ...
            result.append(KeyShare(
                ...
                metadata={
                    'key_id': key_id,
                    'share_format': 'secretsharing-ascii'
                }
            ))
    ...
    def _feldman_split(self, secret: bytes, threshold: int, total_shares: int, key_id: str = None) -> List[KeyShare]:
    ...
    def _pedersen_split(self, secret: bytes, threshold: int, total_shares: int, key_id: str = None) -> List[KeyShare]:
    ...
    def _threshold_ecdsa_keygen(self, threshold: int, total_shares: int, key_id: str = None) -> List[KeyShare]:
    ...
    def _threshold_bls_keygen(self, threshold: int, total_shares: int, key_id: str = None) -> List[KeyShare]:
