    ...
    def login(self, username: str, password: str) -> bool:
        ...
        try:
            ...
            self.security_gateway.log_activity(
                "authentication", "login", f"User {username} logged in", severity="info"
            )
    ...
    def encrypt_file(self, input_path: str, output_path: Optional[str] = None) -> Tuple[bool, str]:
        ...
        try:
            ...
            metadata = EncryptionMetadata(
                ...
                timestamp=time.time(),
                encryption_layers=[
                    {"type": "PQC_HYBRID", "key_id": key_id, "timestamp": time.time()}
                ],
            )
            ...
            encrypted_data, encryption_metadata = self.encryption_engine.encrypt(
                file_data, associated_data=metadata.to_json().encode()
            )
        ...
        try:
            ...
            return {
                ...
                "user_authenticated": bool(
                    self.current_user and self.current_user.get("authenticated")
                ),
