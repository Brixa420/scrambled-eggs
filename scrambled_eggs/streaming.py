...
import hashlib
import logging
from typing import BinaryIO, Optional, Tuple, Generator, Union
...
class StreamEncryptor:
    ...
    def encrypt_file(self, input_path: Union[str, Path, BinaryIO], 
                    output_path: Union[str, Path, BinaryIO]) -> dict:
...
class StreamDecryptor:
    ...
    def decrypt_file(self, input_path: Union[str, Path, BinaryIO],
                    output_path: Union[str, Path, BinaryIO]) -> dict:
...
def encrypt_file_with_progress(input_path: Union[str, Path], 
...
def decrypt_file_with_progress(input_path: Union[str, Path], 
                             output_path: Union[str, Path], 
                             key: bytes,
                             iv: bytes = None,
                             chunk_size: int = DEFAULT_CHUNK_SIZE,
...
if __name__ == "__main__":
    ...
    def main():
        ...
        parser.add_argument('--key', help='Encryption/decryption key (if not provided, will prompt)')
