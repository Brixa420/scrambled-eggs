...
from PySide6.QtCore import Qt, QSize, QTimer, Signal, QObject, QUrl
from PySide6.QtGui import QIcon, QPixmap, QDesktopServices
from PySide6.QtWidgets import (
    QWidget, QVBoxLayout, QHBoxLayout, QLabel, QPushButton, 
    QProgressBar, QMenu, QFileDialog, QMessageBox, QSizePolicy
)

from ..p2p.file_transfer import FileTransfer, FileTransferManager, FileTransferError
...
class FileTransferDialog(QWidget):
    ...
    def update_status(self):
        ...
        completed = sum(1 for w in self.transfer_widgets.values() 
                       if w.transfer.status == "completed")
        failed = sum(1 for w in self.transfer_widgets.values() 
