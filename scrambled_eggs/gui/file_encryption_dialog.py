...
class FileEncryptionDialog(QDialog):
    ...
    def init_ui(self):
        ...
        self.action_button = QPushButton(
            "Encrypt" if self.mode == 'encrypt' else "Decrypt"
        )
    ...
    def init_standard_tab(self):
        ...
        self.input_path_edit.setPlaceholderText("Select a file to encrypt..." if self.mode == 'encrypt' 
    ...
    def browse_output_file(self):
        ...
        file_path, _ = QFileDialog.getSaveFileName(
            ...
            default_name,
            f"Encrypted Files (*{default_extension});;All Files (*)" if self.mode == 'encrypt' 
