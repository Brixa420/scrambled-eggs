...
if __name__ == "__main__":
    ...
    btn_show.clicked.connect(lambda: status_bar.show_temporary_message("This is a temporary message"))
    layout.addWidget(btn_show)
    
    btn_permanent = QPushButton("Show Permanent Message")
    btn_permanent.clicked.connect(lambda: status_bar.show_permanent_message("This is a permanent message"))
    ...
    btn_custom.clicked.connect(lambda: status_bar.show_message("This message will disappear in 2 seconds", 2000))
