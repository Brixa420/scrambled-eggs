...
from PySide6.QtWidgets import (
    ...
    QTabWidget, QDockWidget, QListWidget, QListWidgetItem, QMenu, QMenuBar
)
from PySide6.QtCore import Qt, QSize, QTimer, QSettings, QByteArray, QPoint, QStandardPaths
from PySide6.QtGui import QAction, QIcon, QPixmap, QKeySequence, QPalette, QColor
        ...
        if file_path:
            ...
            if success:
                ...
                QMessageBox.critical(
                    self,
                    "Encryption Failed",
                    f"Failed to encrypt file: {message}"
                )
        ...
        if file_path:
            ...
            if success:
                ...
                QMessageBox.critical(
                    self,
                    "Decryption Failed",
                    f"Failed to decrypt file: {message}"
                )
