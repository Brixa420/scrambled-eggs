...
class PreferencesDialog(QDialog):
    ...
    def browse_save_location(self):
        ...
        directory = QFileDialog.getExistingDirectory(
            self, "Select Default Save Location", self.save_location.text() or ""
        )
        if directory:
    ...
    def load_settings(self):
        ...
        # General settings
        self.theme_combo.setCurrentText(self.settings.value("ui/theme", "System"))
        self.auto_save.setChecked(self.settings.value("auto_save/enabled", False, type=bool))
        self.auto_save_interval.setValue(self.settings.value("auto_save/interval", 5, type=int))

        # Security settings
        self.auto_lock.setChecked(self.settings.value("security/auto_lock", True, type=bool))
        ...
        # Paths
        self.save_location.setText(self.settings.value("paths/save_location", ""))
    ...
    def save_settings(self):
        ...
        self.settings.setValue(
            "security/clear_clipboard_timeout", self.clear_clipboard_timeout.value()
        )
