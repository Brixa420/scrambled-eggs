...
class TorProxyManager:
    ...
    async def _handle_client(
        ...
        task = asyncio.create_task(self._process_client(reader, writer))
        ...
        def cleanup(t):
            if t in self._connections:
                ...
                if self.on_connection_closed:
                    asyncio.create_task(self.on_connection_closed(client_addr[0], client_addr[1]))
    ...
    async def _process_client(
        ...
        try:
            ...
            if atype == 0x01:  # IPv4
                ...
                writer.write(
                    struct.pack("!BBBB", 0x05, 0x08, 0x00, 0x01)
            ...
            try:
                ...
                await asyncio.gather(
                    self._pipe(reader, sock, writer, False), self._pipe(sock, writer, writer, True)
                )
    ...
    async def _pipe(
        self, src: Any, dst: Any, writer: asyncio.StreamWriter, is_socket: bool
    ) -> None:
