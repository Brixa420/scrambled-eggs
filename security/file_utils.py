...
from typing import Optional, Tuple, BinaryIO, Union, List, Dict, Any
...
class FileUtils:
    ...
    @staticmethod
    def validate_file_type(file: Union[FileStorage, BinaryIO, bytes], 
                          allowed_mime_types: Optional[List[str]] = None) -> str:
        """
    ...
    @staticmethod
    def validate_image(file: Union[FileStorage, BinaryIO, bytes], 
    ...
    @staticmethod
    def generate_secure_filename(original_filename: str, 
                               prefix: str = '', 
                               suffix: str = '') -> str:
        """
    ...
    @staticmethod
    def calculate_file_hash(file: Union[FileStorage, BinaryIO, bytes, str], 
