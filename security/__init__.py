...
from .auth import auth_manager, exempt_from_rate_limit, login_required, rate_limit

# Import key components for easier access
from .config import Config, DevelopmentConfig, ProductionConfig, TestingConfig, get_config
from .file_utils import FileSecurityError, file_utils
from .mfa import MFAError, mfa
from .middleware import security_middleware
from .password_utils import PasswordError, PasswordPolicyError, password_utils
...
def init_app(app):
    ...
    if not app.debug:
        ...
        file_handler = RotatingFileHandler(
            log_dir / "scrambled_eggs.log", maxBytes=10 * 1024 * 1024, backupCount=5  # 10MB
        )
