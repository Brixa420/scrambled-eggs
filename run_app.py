...
logging.basicConfig(
    ...
    handlers=[
        ...
        logging.FileHandler('scrambled_eggs_debug.log')
    ]
)
...
def main():
    try:
        ...
        if not apply_patches():
            logger.warning("One or more patches failed to apply, continuing with limited functionality")
        ...
        # Set preferred KDF
        os.environ['SCRAMBLED_EGGS_PREFERRED_KDF'] = config.get('security', 'preferred_kdf', fallback='pbkdf2')
