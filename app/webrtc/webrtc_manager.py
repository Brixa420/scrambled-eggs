"""
WebRTC manager for handling peer connections and media streaming.
"""
import asyncio
import json
import logging
from dataclasses import dataclass, field
from typing import Dict, Optional, Callable, List, Any, Awaitable
...
class WebRTCManager:
    ...
    def __init__(self, config: Optional[WebRTCConfig] = None):
        ...
        self.on_message_callbacks: List[Callable[[str, dict], Awaitable[None]]] = []
        self.on_connection_state_change: Optional[Callable[[str, str], None]] = None
    ...
    async def create_data_channel(self, peer_id: str, label: str = "chat") -> Optional[RTCDataChannel]:
    ...
    def register_message_callback(self, callback: Callable[[str, dict], Awaitable[None]]):
        """Register a callback for incoming messages."""
        if callback not in self.on_message_callbacks:
            self.on_message_callbacks.append(callback)
    
    def unregister_message_callback(self, callback: Callable[[str, dict], Awaitable[None]]):
