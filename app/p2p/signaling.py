...
def init_signaling(socketio):
    ...
    def handle_join(data):
        ...
        join_room(room)
        active_peers[request.sid] = {"room": room, "user_id": user_id, "sid": request.sid}
    ...
    def handle_offer(data):
        ...
        emit("offer", {"from": sender.get("user_id"), "offer": offer}, room=to)
    ...
    def handle_answer(data):
        ...
        sender = active_peers.get(request.sid, {})
        emit("answer", {"from": sender.get("user_id"), "answer": answer}, room=to)
    ...
    def handle_ice_candidate(data):
        ...
        emit("ice_candidate", {"candidate": candidate}, room=to)
