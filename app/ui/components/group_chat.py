    ...
    def _load_messages(self, group_id: str):
        ...
        if group_id not in self.messages:
            ...
            for msg_data in messages_data:
                self.messages[group_id].append(GroupMessage(
        ...
        with self.message_display:
            ...
            for msg in self.messages[group_id]:
                ...
                if msg.is_own:
                    ...
                    print(f"    <div style='font-size: 0.9em; color: #666;'>{msg.sender_name} • {time_str}</div>")
                    ...
                    if status_icon:
                        print(f"    <div style='text-align: right; font-size: 0.8em;'>{status_icon}</div>")
                    
                    print("  </div>")
                    print("</div>")
                else:
                    print(f"<div style='text-align: left; margin: 5px;'>")
                    print(f"  <div><strong>{msg.sender_name}</strong> <span style='font-size: 0.8em; color: #666;'>{time_str}</span></div>")
