...
from PySide6.QtWidgets import (
    ...
    QScrollArea, QFrame, QFileDialog, QMenu, QSizePolicy
)
from PySide6.QtCore import Qt, Signal, QSize, QTimer, QUrl, QMimeData
from PySide6.QtGui import QTextCursor, QTextCharFormat, QFont, QColor, QPixmap, QIcon, QDesktopServices
...
class MessageBubble(QFrame):
    ...
    def setup_ui(self):
        ...
        if self.is_own:
            ...
            self.content_label.setStyleSheet(self.content_label.styleSheet() + """
                QLabel {
...
class ChatAreaWidget(QWidget):
    ...
    def add_message(self, message: Dict[str, Any]):
        ...
        self.messages_layout.insertWidget(
            self.messages_layout.count() - 1,  # Before the stretch
            bubble
        )
