...
from PySide6.QtWidgets import (
    ...
    QSizePolicy, QSpacerItem, QGraphicsOpacityEffect, QSlider
)
...
class CallWidget(QWidget):
    ...
    def setup_ui(self):
        ...
        # Mute button
        self.mute_btn = self.create_call_button(
            "Mute", ":/icons/mic.png", ":/icons/mic_off.png"
        )
    ...
    def create_call_button(self, tooltip: str, icon_path: str, icon_checked_path: str = "") -> QPushButton:
        ...
        if icon_checked_path:
            ...
            btn.toggled.connect(
                lambda checked, b=btn: b.setIcon(
                    b.property("iconChecked") if checked 
                    else b.property("iconUnchecked")
                )
            )
