...
from typing import Optional, Tuple, Dict, Any, Union, List, Type, TypeVar, Callable
...
class ScrambledEggsCrypto:
    ...
    def encrypt(self, data: bytes, key: Optional[bytes] = None, 
               layer: Optional[EncryptionLayer] = None, **kwargs) -> Dict[str, Any]:
        """
    ...
    def decrypt(self, encrypted_data: Dict[str, Any], key: Optional[Union[bytes, str]] = None) -> bytes:
        """
    ...
    def _decrypt_scrambled_eggs(self, encrypted_data: Dict[str, Any], key: bytes) -> bytes:
        ...
        try:
            ...
            try:
                ...
                raise DecryptionError("Invalid authentication tag - the key may be incorrect or data corrupted")
            except Exception as e:
