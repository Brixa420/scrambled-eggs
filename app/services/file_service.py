...
class FileService:
    ...
    def upload_file(
        self, file_data: bytes, filename: str, password: str = None, expiration_days: int = 7
    ) -> Dict[str, Any]:
    ...
    def download_file(
        self, file_id: str, output_path: str = None, password: str = None, key: bytes = None
    ) -> bytes:
...
if __name__ == "__main__":
    ...
    try:
        ...
        decrypted_data = file_service.download_file(
            file_id=result["file_id"], password="securepassword123"
        )
