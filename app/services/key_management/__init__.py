...
from app.config.encryption import get_crypto, config
from app.core.exceptions import EncryptionError, KeyManagementError
    ...
    def get_metrics(self) -> Dict[str, Any]:
        ...
        return {
            **self.metrics,
            ...
            'active_keys': sum(1 for meta in self.key_metadata.values() if meta.get('is_active', False)),
