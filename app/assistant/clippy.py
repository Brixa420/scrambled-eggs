...
class ClippyPersonality:
    ...
    def __init__(self):
        ...
        self.positive_feedback = ["Great!", "Awesome!", "Perfect!", "Excellent!", "Got it!"]
...
class ClippyAssistant(QObject):
    ...
    def process_message(self, message: str):
        ...
        user_msg = ClippyMessage(text=message, is_from_user=True, message_type=MessageType.TEXT)
        ...
        if any(word in message_lower for word in ["hello", "hi", "hey"]):
            response = (
                f"{self.personality.get_positive_feedback()} {self.personality.get_greeting()}"
            )
    ...
    def _send_response(self, response: str):
        ...
        clippy_msg = ClippyMessage(text=response, is_from_user=False, message_type=MessageType.TEXT)
    ...
    def _add_system_message(self, text: str):
        ...
        msg = ClippyMessage(text=text, is_from_user=False, message_type=MessageType.SYSTEM)
...
class ClippyUI(QWidget):
    ...
    def send_message(self):
        ...
        if message:
            self.display_message(
                ClippyMessage(text=message, is_from_user=True, message_type=MessageType.TEXT)
            )
    ...
    def show_help(self):
        ...
        """
        self.display_message(
            ClippyMessage(text=help_text, is_from_user=False, message_type=MessageType.SYSTEM)
        )
    ...
    def show_tip(self, tip: str):
        ...
        self.display_message(
            ClippyMessage(
                text=f"<b>Tip:</b> {tip}", is_from_user=False, message_type=MessageType.SYSTEM
            )
        )
