...
from app.core.exceptions import EncryptionError, DecryptionError, IntegrityCheckError
...
def encrypt_sensitive_data(data: Union[str, dict], context: Optional[dict] = None) -> Dict[str, Any]:
    """
...
def decrypt_sensitive_data(encrypted_data: Dict[str, Any], context: Optional[dict] = None) -> Union[str, dict]:
    """
...
def is_secure_password(password: str) -> Tuple[bool, str]:
    ...
    personal_info = [
        'name', 'user', 'login', 'first', 'last', 'birth', 'date',
        'year', 'month', 'day', 'pet', 'child', 'spouse', 'city', 'team'
    ]
