...
from cryptography.hazmat.primitives.asymmetric import x25519, ec, rsa
from cryptography.hazmat.primitives import serialization
from cryptography.hazmat.backends import default_backend
from cryptography.exceptions import InvalidTag

from .self_modifying import SelfModifyingEncryption, SecurityLevel
    ...
    def decrypt_message(self, 
        ...
        try:
            ...
            try:
                ...
                raise ValueError("Message authentication failed - the message may have been tampered with")
