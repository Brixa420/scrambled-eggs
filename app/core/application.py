...
from app.webrtc.webrtc_manager import WebRTCManager, WebRTCConfig
from app.crypto.encryption_manager import EncryptionManager, KeyPair
from app.models.contact import Contact, ContactStatus
from app.models.message import Message, MessageType, MessageStatus
from app.db.database import DatabaseManager
from app.signaling.signaling_server import SignalingServer, PeerInfo
...
class Application(QObject):
    ...
    def _load_data(self):
        ...
        for contact in contacts:
            ...
            pending_messages = self.db.get_messages(contact_id=contact.id, status=MessageStatus.PENDING)
    ...
    def send_message(self, contact_id: str, content: str, message_type: MessageType = MessageType.TEXT) -> Optional[Message]:
        ...
        try:
            ...
            if contact_id in self.peer_connections and self.peer_connections[contact_id]["connected"]:
                success = self.webrtc.send_message(contact_id, {
                    "type": "message",
    ...
    async def _handle_webrtc_message(self, peer_id: str, data: dict):
        ...
        try:
            ...
            if message_type == "message":
                # Decrypt the message
                decrypted_content = self.encryption.decrypt_message(peer_id, data["content"]).decode('utf-8')
    ...
    async def start_call(self, contact_id: str, call_type: str = "audio") -> bool:
        ...
        try:
            ...
            await self.webrtc.send_message(contact_id, {
                "type": "call-offer",
                "call_type": call_type,
                "offer": offer
            })
    ...
    async def answer_call(self, contact_id: str, answer: dict) -> bool:
        ...
        try:
            ...
            success = await self.webrtc.send_message(contact_id, {
                "type": "call-answer",
                "answer": answer
            })
    ...
    def _on_ice_candidate(self, peer_id: str, candidate: dict):
        ...
        asyncio.create_task(self.webrtc.send_message(peer_id, {
    ...
    def _start_signaling_server(self):
        ...
        try:
            ...
            logger.info(f"Signaling server started on {self.config.get('signaling_host', '0.0.0.0')}:"
