...
class KeyManagementError(EncryptionError):
    ...
    def __init__(
        ...
        """Initialize the exception."""
        super().__init__(
            message=message, error_code=error_code or "KEY_MANAGEMENT_ERROR", details=details
        )
...
class DecryptionError(EncryptionOperationError):
    ...
    def __init__(
        self, message: str = "Decryption failed", details: Optional[Dict[str, Any]] = None
    ):
        """Initialize the exception."""
        super().__init__(operation="decryption", message=message, details=details)
...
class IntegrityCheckError(DecryptionError):
    ...
    def __init__(self, details: Optional[Dict[str, Any]] = None):
        ...
        super().__init__(
            ...
            details={
                "cause": "Integrity check failed - data may have been tampered with",
                **(details or {}),
            },
        )
