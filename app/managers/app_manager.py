...
from app.security.self_modifying import SecurityLevel, SelfModifyingEncryption
...
class AppManager:
    ...
    def __init__(self, config: Optional[Dict[str, Any]] = None):
        ...
        self.security_manager = SelfModifyingEncryption(initial_level=SecurityLevel.MEDIUM)
    ...
    def _handle_incoming_message(self, message: Dict[str, Any]) -> None:
        ...
        try:
            ...
            if not self.crypto_engine.verify_message(
                message["content"].encode(), message["signature"], message["sender_public_key"]
            ):
            ...
            if message["type"] == "text":
                ...
                self._notify_ui(
                    ...
                    {
                        "message": message,
                        "unread_count": self.message_manager.get_unread_count(
    ...
    def send_message(self, recipient_id: str, content: str) -> bool:
        ...
        try:
            ...
            encrypted_content = self.crypto_engine.encrypt_message(
                content, recipient_public_key=self.contact_manager.get_public_key(recipient_id)
            )
