...
class Contact:
    ...
    def from_dict(cls, data: Dict[str, Any]) -> "Contact":
        ...
        return cls(
            ...
            last_online=(
                datetime.fromisoformat(data["last_online"]) if data.get("last_online") else None
            ),
    ...
    def from_qr_code(cls, qr_data: str) -> "Contact":
        ...
        try:
            ...
            if not all(
                k in contact_data for k in ["contact_id", "name", "public_key", "fingerprint"]
            ):
...
class ContactManager:
    ...
    def save_contacts(self) -> bool:
        ...
        try:
            ...
            with tempfile.NamedTemporaryFile(
                mode="w", encoding="utf-8", dir=str(self.data_dir), delete=False
            ) as f:
    ...
    def get_contacts(
        self, group: Optional[str] = None, favorites_only: bool = False
    ) -> List[Contact]:
