...
class SecureChat:
    ...
    def _hkdf(self, input_key_material: bytes, salt: bytes = None, info: bytes = None, 
              length: int = 32) -> bytes:
    ...
    def encrypt_message(self, session_id: str, plaintext: str, ttl: int = None) -> dict:
        ...
        signature = self._sign_message(
            ciphertext,
            self.session_state.identity_key_private
        )
...
if __name__ == "__main__":
    ...
    encrypted_msg = alice_chat.encrypt_message(session_id, "Hello, Bob! This is a secure message.", ttl=3600)
